			...
			<div class="section-content section-call-cta-content">
				<div class="section-title-wrapper text-center">
					...
					<div class="modal-end-cta-button-w">
						<a id="numero" class="button content-button call-cta-big-button" onclick="saveOption(this, 'conversion');" href="tel:<?php echo $phone ?>"><i class="fas fa-phone-alt" aria-hidden="true" style="margin-left: 15px;margin-right: 5px;"></i><span id="numero-texto"><?php echo $phone ?></span></a>
					</div>
				</div>
